...
I keep a single source of truth (this site) and several **role-targeted resume views** so you can land on whichever framing matches the role you're hiring for. Same person, same projects — different emphasis.
...
If you want a custom framing for a specific role, [email me](mailto:{{ site.author.email }}).

---

*This site is maintained with AI-assisted tooling (Claude Code) — same engineer-meets-AI pattern I apply to research and dev workflows.*
